  ...
  const submitHandler = async (e) => {
    ...
    if (password === confirmPassword) {
      if (password.length < 8) {
        ...
        axios
          .post("https://localhost:7005/api/RegisterSeller", {
          ...
          .then((res) => {
            if (200 <= res.status && res.status < 300) {
              successAlert({
                title: "Registered",
                message: "New Seller has been registered!",
              });
              ...
              warningAlert({
                ...
                message:
                  "There has been an error in registering the Seller. Please try again later!!",
              });
              setBtnText("Register");
              setDisableId("");
              setValidation("");
          ...
          .catch((e) => {
            ...
            if (e.response.status && e.response.status === 404) {
              warningAlert({
                title: "Registration Failed",
                message: "Seller with the email already exists!!",
              });
            } else {
              warningAlert({
                title: "Registration Failed",
        ...
        <div className="form-content">
          <form onSubmit={submitHandler}>
            ...
            >
              <Container>
                <CardTitle>
                  <h1 className="h3 p-2">Register Seller</h1>
                </CardTitle>
                <CardBody>
                  <Row>
                    <TextField
